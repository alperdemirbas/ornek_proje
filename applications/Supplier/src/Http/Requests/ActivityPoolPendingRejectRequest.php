...
class ActivityPoolPendingRejectRequest extends FormRequest
{
    /**
    ...
    {
        return (Auth::guard('companies')->user()->can(PermissionsEnum::SUPPLIER_ACTIVITY_POOL_PENDING_REJECT->value));
    }
