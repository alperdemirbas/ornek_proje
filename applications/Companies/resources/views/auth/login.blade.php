                                        ...
                                        <div class="nav nav-tabs border-bottom-0" id="nav-tab" role="tablist">
                                            <div class="tab-content w-100" id="nav-tabContent">
                                                <div class="tab-pane fade show active" id="nav-personal" role="tabpanel"
                                                    ...
                                                    @endif
                                                    <form action="{{ _route('companies.login')}}" method="POST">
                                                        @csrf
                                                        <h3 class="form-title m-t0">{{__('company.login_title')}}</h3>
                                                        <div class="dez-separator-outer m-b5">
                                                            <div class="dez-separator bg-primary style-liner"></div>
                                                        </div>
                                                        <p>{{__('company.login_sub_title')}}</p>
                                                        <div class="form-group mb-3">
                                                            <input name="email" required class="form-control"
                                                                   placeholder="{{__('general.email')}}" type="text">
                                                        </div>
                                                        ...
                                                        <div class="form-group text-left mb-3">
                                                            <a href="#">{{__('company.forgot_password')}}</a>
                                                        </div>

                                                        <div>
                                                            <button class="btn btn-sm btn-primary w-100 me-3">{{__('company.login')}}</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
