...
class TourismActivityDisableFromPoolRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'id' => 'required|integer|exists:tourism_company_activities,id,status,'.ActivityStatus::ACTIVE->value,
        ];
    }
