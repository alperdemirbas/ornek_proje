            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="footer-inner text-center ">
                        <p class="copyright-text wow fadeInUp" data-wow-delay="2.4s">&copy; <?php echo e(now()->format('Y')); ?> Rezyon. <br /> Developed by <a class="text-primary" href="https://kaat.digital" target="_blank">Kaat Digital</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Footer End --><?php /**PATH /var/www/html/applications/PaymentManagement/src/../resources/views/includes/footer.blade.php ENDPATH**/ ?>