                    ...
                    <div class="col-12 col-lg-8 offset-lg-2">
                        <div class="card">
                            <div class="card-body text-center">
                                <div class="dummy-positioning d-flex mb-4">
                                ...
                                <h2 class="mb-2">Ödeme Talebiniz Alındı</h2>
                                <p class="fs-4">Ödemenizin sonucu kısa bir süre içinde SMS ve E-posta yoluyla size bildirilecektir.</p>
                            </div>
                        </div>
                    </div>
                </div>
